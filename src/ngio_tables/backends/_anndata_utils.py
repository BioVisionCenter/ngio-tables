...
from ngio_tables._utils import NgioTablesValueError, StoreOrGroup, open_group_wrapper
from ngio_tables._utils._zarr_utils import is_group_listable
...
def custom_anndata_read_zarr(
    ...
    if not isinstance(adata, AnnData):
        raise NgioTablesValueError(f"Expected an AnnData object, but got {type(adata)}")
    return adata
